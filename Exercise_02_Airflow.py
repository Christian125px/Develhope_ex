...
def python_first_function(): 
    ...
    print("Data attuale:", data_attuale.strftime("%Y-%m-%d %H:%M:%S"))
...
# crontab notation can be useful https://crontab.guru/#0_0_*_*_1
with DAG("first_python_dag_2", schedule_interval = '@daily', catchup=False, default_args = default_dag_args) as dag_python:
